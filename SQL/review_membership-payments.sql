...
where mp."membershipId" = 'be606d30-5786-11f0-ad79-4f3949f65f4c'
--where mp."mpPaymentId" = '153314619317'
...
where mp."membershipId" = 'ede06560-83b9-11f0-bd37-fd81ada92f73'
...
where u.email like 'molinasalinas1993@gmail.com'
